...
import { cookies as nextCookiesFunc } from 'next/headers';
import { AmplifyServerContextSpec } from '@aws-amplify/framework-core';
...
export namespace NextServer {
	...
	export type ServerComponentContext = {
		cookies: typeof nextCookiesFunc;
	};

	export type ServerActionContext = ServerComponentContext;

	/**
	 * This context is normally available in the [`getServerSideProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-server-side-props)
